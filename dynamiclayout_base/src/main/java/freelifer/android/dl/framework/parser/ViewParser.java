...
/**
  ...
  @Override
  public DView createView(final DViewContext context, Layout layout, ViewGroup parent, int dataIndex) {
    return new DView() {
      @Override
      ...
      public View getAsView() {
        TextView textView = new TextView(context.getBaseContext());
        textView.setText("kdsf;ijsdflksdjflksdjfl;sdk");
        return textView;
      }
    };
  }
